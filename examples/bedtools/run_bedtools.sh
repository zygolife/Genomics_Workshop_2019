...
ln -s ../../data/genomic/C_lusitaniae.SampleA.vcf.gz
...
bedtools intersect -a candida_lusitaniae_1.genes.gff3 -b C_lusitaniae.SampleA.vcf.gz -wb | cut -f9 | perl -p -e 's/ID.+Name=//' | sort | uniq -c | sort -rn > genes_by_snpcount.txt
