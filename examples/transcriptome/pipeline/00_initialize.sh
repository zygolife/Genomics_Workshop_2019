...
if [ -d /bigdata/stajichlab/shared/tmp/Rhizopus/SRR7208621 ]; then
	ln -s /bigdata/stajichlab/shared/tmp/Rhizopus/SRR7208621/SRR7208621_1.fastq.gz $FASTQ/Rd_24hr_1.fastq.gz
	ln -s /bigdata/stajichlab/shared/tmp/Rhizopus/SRR7208621/SRR7208621_2.fastq.gz $FASTQ/Rd_24hr_2.fastq.gz
	...
	ln -s SRR7208621/SRR7208621_1.fastq.gz $FASTQ/Rd_24hr_1.fastq.gz
	ln -s SRR7208621/SRR7208621_2.fastq.gz $FASTQ/Rd_24hr_2.fastq.gz
fi

if [ -d /bigdata/stajichlab/shared/tmp/Rhizopus/SRR7208587 ]; then
	ln -s /bigdata/stajichlab/shared/tmp/Rhizopus/SRR7208587/SRR7208587_1.fastq.gz $FASTQ/Rd_3hr_1.fastq.gz
	ln -s /bigdata/stajichlab/shared/tmp/Rhizopus/SRR7208587/SRR7208587_2.fastq.gz $FASTQ/Rd_3hr_2.fastq.gz
...
# this dataset is one of several replicates which are for the 3hr time point of spore germination
	...
	ln -s SRR7208587/SRR7208587_1.fastq.gz $FASTQ/Rd_3hr_1.fastq.gz
	ln -s SRR7208587/SRR7208587_1.fastq.gz $FASTQ/Rd_3hr_2.fastq.gz
fi
